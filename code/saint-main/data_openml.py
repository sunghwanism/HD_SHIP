...
def data_prep(seed, train_x, train_y, test_x, category_col, datasplit=[.80, .20,]):
    ...
    attribute_names = train_x.columns.tolist()
    ...
    return cat_dims, cat_idxs, con_idxs, X_train, y_train, X_valid, y_valid, train_mean, train_std
